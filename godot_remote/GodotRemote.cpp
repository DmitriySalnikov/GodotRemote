...
GR_PS_NAME_TYPE GodotRemote::ps_server_image_sequence_threads_count_name = "debug/godot_remote/server/image_sequence_threads_count";
...
#define DEF_(name, def_val, info_type, info_hint_type, info_hint_string) \
	...
	DEF_(ps_server_image_sequence_threads_count_name, 3, Variant::INT, PROPERTY_HINT_RANGE, "1,16");
